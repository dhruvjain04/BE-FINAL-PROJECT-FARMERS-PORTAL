...
const Login = () => {
    ...
    const loginUser = async (e) => {
        ...
        if (user.role === 'farmer') {
            url = 'http://localhost:8001/farmer/farmerLogin'; // Replace with the farmer signin route
        } else if (user.role === 'exporter') {
            url = 'http://localhost:8001/user/exporterLogin'; // Replace with the exporter sigin route
        }
